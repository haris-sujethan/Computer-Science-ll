...
class FillInQuestion extends Question {
   ...
   public FillInQuestion(String questionText) {
      ...
      int firstUnderscore = questionText.indexOf('_');
      int secondUnderscore = questionText.indexOf(underscore);
      setAnswer(questionText.substring(firstUnderscore + 1, secondUnderscore));

      String underscores = "";
      for (int i = 0; i < (secondUnderscore - firstUnderscore + 1); i++) {
         underscores += "_";
      }

      setQuestion(questionText.substring(0, firstUnderscore) + underscores);
